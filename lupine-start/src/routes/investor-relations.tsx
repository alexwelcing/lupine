    ...
    <main className="relative flex-1 bg-[var(--surface)] overflow-hidden">
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            >
              ...
              <p className="text-[var(--on-surface-variant)] text-xl md:text-2xl mb-12 max-w-3xl leading-snug font-serif italic">
              ...
              <div className="flex gap-6 items-center flex-wrap">
                ...
                <Link
                  to="/"
                  className="px-6 py-3 border border-[var(--secondary)] text-[var(--secondary)] font-mono text-sm uppercase tracking-[0.08em] hover:bg-[var(--secondary)] hover:text-[var(--surface)] transition-colors no-underline"
                >
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="flex justify-between items-baseline">
                      ...
                      <span className="font-mono text-2xl text-[var(--secondary)]">18</span>
                    </div>
                    <div className="flex justify-between items-baseline">
                      <span className="mono-label text-[var(--on-surface-variant)] text-[10px]">BENCHMARK RECORDS</span>
                      <span className="font-mono text-2xl text-[var(--tertiary)]">7,940</span>
                    </div>
                    <div className="flex justify-between items-baseline pt-4 border-t border-[var(--outline-variant)]">
                      ...
                      <span className="font-mono text-base text-[var(--on-surface)]">Apache 2.0</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <Section>
        <div className="max-w-5xl mx-auto py-8">
          ...
          <h2 className="font-serif tracking-tight text-4xl lg:text-5xl mb-6 leading-[1.05] text-[var(--on-surface)]">A measurement business that compounds into a model business.</h2>
      ...
      <Section>
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
          <div>
            ...
            <h2 className="font-serif tracking-tight text-4xl lg:text-5xl mb-6 leading-[1.05] text-[var(--on-surface)]">A 12-month <span className="text-[var(--secondary)] italic glow-secondary">trust window</span></h2>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card elevated className="relative overflow-hidden group">
            ...
            <div className="font-mono text-4xl text-[var(--primary)] mb-2">0.93</div>
          ...
          <Card elevated className="relative overflow-hidden group">
            <div className="absolute -top-16 -right-16 w-32 h-32 bg-[var(--violet-500)] opacity-10 blur-[40px] rounded-full group-hover:opacity-20 transition-all"></div>
            <div className="font-mono text-4xl text-[var(--violet-500)] mb-2">$650M+</div>
          ...
          <Card elevated className="relative overflow-hidden group">
            ...
            <div className="font-mono text-4xl text-[var(--secondary)] mb-2">2024</div>
      ...
      <Section bg="light">
        <div className="max-w-4xl mx-auto py-8">
          ...
          <h2 className="font-serif tracking-tight text-4xl lg:text-5xl mb-6 leading-[1.05] text-[var(--on-surface)]">Infrastructure for the downstream</h2>
      ...
      <Section>
        <div className="max-w-4xl mx-auto py-8">
          ...
          <h2 className="font-serif tracking-tight text-4xl lg:text-5xl mb-6 leading-[1.05] text-[var(--on-surface)]">What we will not pretend</h2>
          <div className="space-y-8 text-[var(--on-surface-variant)] text-lg leading-relaxed">
            <div>
              <h3 className="text-[var(--on-surface)] font-medium mb-2 font-sans tracking-wide">We are not "AlphaFold for materials."</h3>
              <p className="text-[var(--on-surface-variant)] leading-relaxed mb-6">That phrase died with the Cheetham &amp; Seshadri (2024) and Leeman et al. (2024) critiques of GNoME. It is a marker of unsophistication. We do not use it.</p>
            </div>
            <div>
              <h3 className="text-[var(--on-surface)] font-medium mb-2 font-sans tracking-wide">We are not replacing DFT or LAMMPS.</h3>
              <p className="text-[var(--on-surface-variant)] leading-relaxed mb-6">DFT is the training signal for every modern MLIP. LAMMPS is the integrator MLIPs run inside, via the KIM API and architecture-specific plugins (MACE, NequIP, Allegro, DeePMD). Anyone who claims to "replace" either tells you they have not used either.</p>
            </div>
            <div>
              <h3 className="text-[var(--on-surface)] font-medium mb-2 font-sans tracking-wide">We do not solve the sim-to-lab gap.</h3>
              <p className="text-[var(--on-surface-variant)] leading-relaxed mb-6">John Gregoire (Lila Sciences) is right: zero problems are solved by simulation alone. A trust layer for simulation makes the simulation half of the loop honest. The synthesis half is somebody else's company — Periodic Labs, CuspAI, A-Lab — and the audit layer is more valuable to those companies, not less.</p>
            </div>
            <div>
              <h3 className="text-[var(--on-surface)] font-medium mb-2 font-sans tracking-wide">"Hyper-ribbon" is not our coinage.</h3>
              <p className="text-[var(--on-surface-variant)] leading-relaxed mb-6">Transtrum, Machta &amp; Sethna introduced it in <em>Phys. Rev. E</em> 83, 036701 (2011). We cite it. Failing to cite would be embarrassing — Sethna and Tadmor are likely IMMI reviewers, and OpenKIM is the infrastructure our manifest sits on. The novelty we own is narrower and more durable: cross-potential PCA error-fingerprinting across the full population of published interatomic potentials.</p>
            </div>
            <div>
              <h3 className="text-[var(--on-surface)] font-medium mb-2 font-sans tracking-wide">We do not promise scaling-law exponents we cannot back up.</h3>
              <p className="text-[var(--on-surface-variant)] leading-relaxed mb-6">Open Direction 7 of Simon et al. (2026) — predict scaling-law exponents <em>a priori</em> — is genuinely open. We claim that the manifest is the right place to look, and that named retraining targets compound retraining sample efficiency in the direction Bordelon, Atanasov &amp; Pehlevan (2025) document for general kernel methods. We do not claim a closed-form prediction yet. The honest position is more durable than the inflated one.</p>
            </div>
          </div>
        </div>
      </Section>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="glass-panel-elevated p-12 md:p-20 relative overflow-hidden">
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="font-serif tracking-tight text-4xl lg:text-5xl mb-6 leading-[1.05] text-[var(--on-surface)]">Data room</h2>
              ...
              <div className="flex flex-col md:flex-row gap-4 max-w-md mx-auto">
                <a
                  href="mailto:alexwelcing@gmail.com?subject=Lupine%20data%20room%20request"
                  className="flex-grow px-6 py-4 bg-[var(--primary)] text-[var(--on-primary)] font-mono text-sm uppercase tracking-[0.08em] hover:opacity-90 transition-opacity text-center no-underline"
                >
