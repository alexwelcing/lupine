    ...
    <main className="relative flex-1 bg-[var(--surface)] overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            >
              ...
              <div className="flex gap-6 items-center flex-wrap">
                ...
                <Link
                  to="/"
                  className="px-6 py-3 border border-[var(--secondary)] text-[var(--secondary)] font-mono text-sm uppercase tracking-widest hover:bg-[var(--secondary)] hover:text-[var(--surface)] transition-colors no-underline"
                >
      ...
      <Section>
        <div className="max-w-5xl mx-auto py-8">
          ...
          <h2 className="font-display tracking-tight text-4xl lg:text-5xl mb-6 leading-[1.05] text-[var(--on-surface)]">A measurement business that compounds into a model business.</h2>
      ...
      <Section>
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
          <div>
            ...
            <h2 className="font-display tracking-tight text-4xl lg:text-5xl mb-6 leading-[1.05] text-[var(--on-surface)]">A 12-month <span className="text-[var(--secondary)] italic glow-secondary">trust window</span></h2>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card elevated className="relative overflow-hidden group">
            ...
            <div className="font-mono text-4xl text-violet-400 mb-2">$650M+</div>
      ...
      <Section bg="light">
        <div className="max-w-4xl mx-auto py-8">
          ...
          <h2 className="font-display tracking-tight text-4xl lg:text-5xl mb-6 leading-[1.05] text-[var(--on-surface)]">Infrastructure for the downstream</h2>
      ...
      <Section>
        <div className="max-w-4xl mx-auto py-8">
          ...
          <h2 className="font-display tracking-tight text-4xl lg:text-5xl mb-6 leading-[1.05] text-[var(--on-surface)]">What we will not pretend</h2>
          <div className="space-y-8 text-[var(--on-surface-variant)] text-lg leading-relaxed">
            ...
            <div>
              ...
              <p className="font-serif italic text-lg leading-relaxed text-[var(--on-surface-variant)]">Open Direction 7 of Simon et al. (2026) — predict scaling-law exponents <em>a priori</em> — is genuinely open. We claim that the manifest is the right place to look, and that named retraining targets compound retraining sample efficiency in the direction Bordelon, Atanasov &amp; Pehlevan (2025) document for general kernel methods. We do not claim a closed-form prediction yet. The honest position is more durable than the inflated one.</p>
            </div>
          </div>
        </div>
      </Section>
          ...
          <div className="glass-panel-elevated p-12 md:p-20 relative overflow-hidden">
            ...
            <div className="relative z-10 text-center">
              ...
              <div className="flex flex-col md:flex-row gap-4 max-w-md mx-auto">
                <a
                  href="mailto:alexwelcing@gmail.com?subject=Lupine%20data%20room%20request"
                  className="flex-grow px-6 py-4 bg-[var(--primary)] text-[var(--on-primary)] font-mono text-sm uppercase tracking-widest hover:opacity-90 transition-opacity text-center no-underline"
                >
