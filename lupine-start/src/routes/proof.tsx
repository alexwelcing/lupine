      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="mb-16">
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="mono-label text-[var(--primary)] glow-primary">RESEARCH DEFENSE: LIVE</span>
          </div>
          <h1 className="text-5xl lg:text-6xl mb-6">The Causal Geometry of Prediction Errors</h1>
          <p className="text-[var(--on-surface-variant)] text-lg leading-relaxed max-w-3xl">
            A rigorous response to critique of Welcing (2025). Every claim below is
            backed by computational experiment, formal causal identification, or
            reproducible code. This is not a preprint — it is a theorem with data.
          </p>
        </div>

        {/* Critique vs Rebuttal */}
