    ...
    <header className="sticky top-0 z-50 bg-[var(--surface)]/90 backdrop-blur-md border-b border-[var(--outline-variant)]">
      <div className="container mx-auto px-6 lg:px-12 h-20 flex items-center justify-between max-w-7xl">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <Link to="/lab" className="font-mono text-xs font-semibold text-[var(--on-surface-variant)] uppercase tracking-widest no-underline transition-colors hover:text-[var(--primary)]" activeProps={{ className: 'text-[var(--primary)]' }}>
            Lab
          </Link>
