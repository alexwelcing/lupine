...
impl FromStr for NodeKind {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "error_type" => Ok(NodeKind::ErrorType),
            "material_class" => Ok(NodeKind::MaterialClass),
            "discovery_chain" => Ok(NodeKind::DiscoveryChain),
            "acceptance_test" => Ok(NodeKind::AcceptanceTest),
            "emblem" => Ok(NodeKind::Emblem),
            "claim" => Ok(NodeKind::Claim),
            "time_gate" => Ok(NodeKind::TimeGate),
