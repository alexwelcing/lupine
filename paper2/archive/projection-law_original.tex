...
non-convex immersions (local normal cone), and Hoeffding entrywise concentration of
the empirical second-moment matrix. We then test the law's sharpest
...
reference--prediction correlation $0.95$, error dimensionality --- the
hyper-ribbon geometry of ensemble error vectors, not parameter-space
sloppy-model ribbons --- invariant over forty years. Foundation machine-learned potentials (8 MatPES models: 4
architectures $\times$ 2 training functionals): errors cluster by training
functional, not architecture ($S_{\mathrm{func}}{=}{+}0.317$ vs.\
$S_{\mathrm{arch}}{=}{-}0.093$, exact permutation $p{=}0.029$, i.e.\ 2 of all 70 labelings at the resolution floor; the registered
...
The complete kit, pinned datasets, and pre-registrations are publicly served at \url{https://storage.googleapis.com/shed-489901-replication/error-geometry/v1-10c18ace/index.html}; the citable Zenodo snapshot is archived at \url{https://doi.org/10.5281/zenodo.20787874}. The Lean~4 artifact (225 theorem and lemma declarations in the current
...
This work was supported by Lupine Science. AI assistance (Anthropic Claude, OpenAI Codex, and Kimi)
