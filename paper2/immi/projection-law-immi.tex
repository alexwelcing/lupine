...
\author{Alex Welcing\\ \small Lupine Science, Union City, NJ\\ \small \texttt{alexwelcing@gmail.com}\\[2pt]
...
with explicit ribbon-collapse rate; ribbon/consensus decoupling; affine
decomposition of closed affine reachable sets; local normal-cone theorem for
$C^1$ smooth non-convex immersions; and Hoeffding concentration of the empirical
...
$S_{\mathrm{arch}}{=}{-}0.093$, exact permutation $p{=}0.029$); the registered
rotation prediction confirmed on Au and Pt under r$^2$SCAN but not Ag. DFT
