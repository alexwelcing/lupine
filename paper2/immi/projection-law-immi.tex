...
% *** OUT OF SYNC: master revised 2026-06-11 (adversarial-review revision R2:
% *** canonical dataset numbers, OOS 69% correction claim, registered-failure
% *** honesty, robustness results). REGENERATE FROM MASTER BEFORE SUBMISSION.
