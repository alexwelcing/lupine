...
async function renderHome() {
  ...
  try {
    ...
    reportLink.append(el('span', { style: 'font-size:0.75rem;text-transform:uppercase;color:var(--lupine-300);font-weight:700;letter-spacing:0.05em;' }, '◆ Interactive series · 3 parts'));
