...
const STRINGS = {
  en: {
    ...
    'home.preprint.badge': 'IMMI Preprint',
    'home.preprint.title': 'The Causal Geometry of Prediction Errors in Interatomic Potentials',
    'home.preprint.sub': 'A hyper-ribbon manifold analysis of cross-potential error. In press, Integrating Materials and Manufacturing Innovation (IMMI).',
  ...
  zh: {
    ...
    'home.preprint.badge': 'IMMI 预印本',
    'home.preprint.title': '原子间势预测误差的因果几何',
    'home.preprint.sub': '跨势函数误差的超带流形分析。已被 Integrating Materials and Manufacturing Innovation (IMMI) 接收。',
    'home.continue': '继续阅读',
