...
ATLAS_VIEW_ROOT = Path(__file__).resolve().parents[2]
REPO_ROOT = ATLAS_VIEW_ROOT.parents[1]
OUTPUT_DIR = ATLAS_VIEW_ROOT / 'apps' / 'web' / 'public' / 'gallery' / 'research'
NIST_CSV = REPO_ROOT / 'nist_benchmark.csv'
MANIFOLD_JSON = REPO_ROOT / 'benchmark_manifold.json'
