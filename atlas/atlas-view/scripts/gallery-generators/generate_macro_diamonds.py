...
OUTPUT_DIR = Path(__file__).resolve().parents[2] / "apps" / "web" / "public" / "gallery" / "curated" / "popular"
...
def generate_brilliant_diamond(nx, ny, nz, a=3.567):
    ...
    filename1 = OUTPUT_DIR / "brilliant_diamond_macro.xyz"
    ...
    filename2 = OUTPUT_DIR / "rough_octahedron_diamond.xyz"
