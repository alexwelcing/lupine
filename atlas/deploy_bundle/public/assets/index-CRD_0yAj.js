const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./App-tYIdQxtH.js","./vendor-three-ClbWQ1cI.js","./vendor-postprocess-DrLu1uUn.js","./App-CNCQb1kB.css"])))=>i.map(i=>d[i]);
...
(async ()=>{
    ...
    let d, n = null;
    try {
        d = (await p(()=>import("./App-tYIdQxtH.js").then(async (m)=>{
                await m.__tla;
                return m;
