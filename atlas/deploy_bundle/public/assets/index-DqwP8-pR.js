const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./App-DC4o0gk8.js","./vendor-three-DXS2DCSU.js","./vendor-postprocess-Bo_Yp5T4.js","./App-CNCQb1kB.css"])))=>i.map(i=>d[i]);
...
(async ()=>{
    ...
    let d, n = null;
    try {
        d = (await p(()=>import("./App-DC4o0gk8.js").then(async (m)=>{
                await m.__tla;
                return m;
